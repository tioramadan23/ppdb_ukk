            ...
            <div class="space-y-6 md:space-y-8">
                ...
                <article class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 leading-relaxed text-base md:text-lg">
                        SMK Bina Putra Mandiri (SMK BPM) adalah lembaga pendidikan vokasi yang berkomitmen penuh untuk mencetak tenaga kerja profesional di bidang teknologi informasi, desain digital, dan bisnis modern. Didirikan pada tahun 2007, kami telah menjadi pilihan utama bagi generasi muda yang ingin meraih kesuksesan di era digital.
                    </p>
                </article>
